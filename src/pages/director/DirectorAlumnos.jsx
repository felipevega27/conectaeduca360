    ...
    <div className="flex-1 overflow-y-auto bg-gray-50/50 dark:bg-gray-900 transition-colors duration-300 pb-10 px-4 sm:px-8 pt-8">
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm px-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl border border-gray-200 dark:border-gray-700 animate-[fadeInUp_0.2s_ease-out] overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={guardarEdicion} className="p-6 overflow-y-auto space-y-6">
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-100 dark:border-gray-700 shrink-0">
                ...
                <button type="submit" disabled={isSavingEdit} className="flex-1 py-2.5 rounded-xl bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 transition-all shadow-md shadow-blue-600/20 flex justify-center items-center">
                  {isSavingEdit ? <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div> : 'Guardar Cambios'}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-sm p-6 border border-gray-200 dark:border-gray-700 animate-[fadeInUp_0.2s_ease-out]">
            ...
            {isDeleting ? (
              ...
              <div className="flex gap-3">
                ...
                <button onClick={confirmarEliminacion} className="flex-1 py-2.5 rounded-lg bg-red-600 text-white font-medium text-sm hover:bg-red-700 transition-colors shadow-lg shadow-red-600/20">
                  Sí, eliminar
                </button>
              </div>
            )}
