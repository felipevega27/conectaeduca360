    ...
    <div className="h-screen overflow-hidden flex bg-gray-50 dark:bg-gray-900 font-sans transition-colors duration-300">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-sm flex flex-col transition-all duration-300 lg:static lg:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
        ...
        <div className={`h-16 flex items-center border-b border-gray-200 dark:border-gray-700 ${isCollapsed ? 'lg:justify-center justify-between px-4' : 'justify-between px-4'}`}>
          ...
          <div className={`flex items-center space-x-2 overflow-hidden cursor-pointer ${isCollapsed ? 'lg:hidden' : ''}`} onClick={() => { navigate('/panel/director'); setIsMobileMenuOpen(false); }}>
          ...
          <div className={`items-center justify-center cursor-pointer ${isCollapsed ? 'hidden lg:flex' : 'hidden'}`} onClick={() => { navigate('/panel/director'); setIsMobileMenuOpen(false); }}>
          ...
          <div className={`mb-4 ${isCollapsed ? 'px-2' : 'px-4'}`}>
            ...
            <nav className="space-y-1">
              ...
              <button
                ...
                className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${isItemActive('/panel/director') && !isItemActive('/panel/director/docentes') && !isItemActive('/panel/director/alumnos') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${location.pathname.includes('/panel/director/cursos')
              ...
              <div className="relative">
                <button
                  ...
                  title={isCollapsed ? "Directorio Docente" : ""}
                  className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${openSubmenus.docentes || isItemActive('/panel/director/docentes') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                >
                  <svg className={`h-5 w-5 shrink-0 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  {!isCollapsed && <span>Directorio Docente</span>}
                  {!isCollapsed && (
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openSubmenus.docentes ? 'max-h-40 mt-1' : 'max-h-0'}`}>
                  <div className={`space-y-1 ${isCollapsed ? 'px-0' : 'pl-11'}`}>
                    <button
                      ...
                      title={isCollapsed ? "Lista Docente" : ""}
                    ...
                    >
                      {isCollapsed ? <span className="font-bold text-xs uppercase">LD</span> : <span>Lista Docente</span>}
                    </button>
                    <button
              ...
              <div className="relative">
                <button
                  ...
                  className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${openSubmenus.alumnos || isItemActive('/panel/director/alumnos') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                >
                  <svg className={`h-5 w-5 shrink-0 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {!isCollapsed && <span>Directorio Alumno</span>}
                  {!isCollapsed && (
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openSubmenus.alumnos ? 'max-h-40 mt-1' : 'max-h-0'}`}>
                  <div className={`space-y-1 ${isCollapsed ? 'px-0' : 'pl-11'}`}>
                    ...
                    >
                      {isCollapsed ? <span className="font-bold text-xs uppercase">LI</span> : <span>Lista Alumno</span>}
                    </button>
                    <button
              ...
              <div className="relative">
                <button
                  ...
                  className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${openSubmenus.gestion ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                >
                  <svg className={`h-5 w-5 shrink-0 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${location.pathname.includes('/panel/director/utp')
                  ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${location.pathname.includes('/panel/director/programa-pie')
                  ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${location.pathname.includes('/panel/director/documentos')
                  ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center py-2 text-sm font-medium rounded-lg transition-colors ${isCollapsed ? 'justify-center px-0' : 'px-4'} ${location.pathname.includes('/panel/director/configuracion')
                  ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }`}
              >
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <TopHeader
          ...
          profilePath="/panel/director/mi-perfil"
        />
